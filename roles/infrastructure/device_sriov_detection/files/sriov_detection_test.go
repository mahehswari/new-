...
func IntitializeDevicesSlices() {
	...
	REGULAR_DEVICES_SLICE = []SupDevice{
		{"eth0", "0000:cc:00.0", "0d58", "i40e", 40000, 64, 1, 1, "", false, false, false, 0, "0000:cc:00.x", false, false, false},
		{"eth3", "0000:b1:00.0", "0d58", "i40e", 40000, 64, 1, 1, "", false, false, false, 0, "0000:b1:00.x", false, false, false},
		{"eth4", "0000:31:00.0", "159b", "ice", 65535, 128, 0, 0, "", false, false, false, 0, "0000:31:00.x", false, false, false},
		{"eth6", "0000:b1:00.1", "159b", "ice", 25000, 128, 0, 1, "", false, false, false, 1, "0000:b1:00.x", false, false, false},
		{"eth10", "0000:ee:00.0", "159b", "ice", 25000, 128, 0, 1, "", false, false, false, 0, "0000:ee:00.x", false, false, false},
		{"eth11", "0000:ee:00.1", "159b", "ice", 25000, 128, 0, 1, "", false, false, false, 1, "0000:ee:00.x", false, false, false},
		{"eth12", "0000:ff:00.0", "159b", "ice", 25000, 128, 0, 1, "", false, false, false, 0, "0000:ff:00.x", false, false, false},
		{"eth13", "0000:ff:00.1", "159b", "ice", 25000, 128, 0, 1, "", false, false, false, 1, "0000:ff:00.x", false, false, false},
		{"eth14", "0000:gg:00.0", "159b", "ice", 25000, 64, 0, 1, "", false, false, false, 0, "0000:gg:00.x", false, false, false},
		{"eth15", "0000:gg:00.1", "159b", "ice", 25000, 63, 0, 1, "", false, false, false, 1, "0000:gg:00.x", false, false, false},
	}

	PTP_DEVICES_SLICE = []SupDevice{
		{"eth1", "0000:cc:00.1", "0d58", "i40e", 40000, 128, 1, 1, "", false, true, false, 1, "0000:cc:00.x", false, false, false},
		{"eth7", "0000:dd:00.0", "0d58", "i40e", 40000, 64, 1, 1, "", false, true, false, 0, "0000:dd:00.x", false, false, false},
		{"eth9", "0000:ii:00.0", "0d58", "i40e", 40000, 64, 1, 1, "", false, true, false, 0, "0000:ii:00.x", false, false, false},
		{"eth16", "0000:ii:00.1", "0d58", "i40e", 40000, 64, 1, 1, "", false, true, false, 1, "0000:ii:00.x", false, false, false},
	}

	RRU_DEVICES_SLICE = []SupDevice{
		{"eth2", "0000:dd:00.1", "0d58", "i40e", 40000, 64, 1, 1, "", false, false, true, 1, "0000:dd:00.x", false, false, false},
		{"eth5", "0000:31:00.1", "159b", "ice", 65535, 128, 0, 0, "", false, false, true, 1, "0000:31:00.x", false, false, false},
		{"eth8", "0000:hh:00.0", "0d58", "i40e", 40000, 64, 1, 1, "", false, false, true, 0, "0000:hh:00.x", false, false, false},
		{"eth17", "0000:hh:00.1", "0d58", "i40e", 40000, 64, 1, 1, "", false, false, true, 1, "0000:hh:00.x", false, false, false},
	}
}
...
func InitializeCriteriaListsMap() {
	...
	firstCriteriaList := CriteriaList{"APP", []string{"158a", "0d58", "1593", "159b", "1592", "188a"}, nil, 0, 100,
		2, -1, nil, false, false, false, -1, "", false, "", ""}
	...
	thirdCriteriaList := CriteriaList{"APP", []string{"158a", "0d58", "1593", "159b", "1592", "188a"}, nil, 0, 64,
		2, -1, nil, false, false, false, -1, "pf6", false, "", ""}
	...
	sixthCriteriaList := CriteriaList{"APP", []string{"158a", "0d58", "1593", "159b", "1592", "188a"}, nil, 0, 64,
		2, -1, nil, false, false, false, -1, "pf3", false, "", ""}
	...
	seventhCriteriaList := CriteriaList{"APP", []string{"158a", "0d58", "1593", "159b", "1592", "188a"}, nil, 0, 64,
		2, -1, nil, false, false, false, -1, "pf8", false, "", ""}
	...
	eighthCriteriaList := CriteriaList{"APP", []string{"158a", "0d58", "1593", "159b", "1592", "188a"}, nil, 0, 64,
		2, -1, nil, false, false, false, -1, "pf7", false, "", ""}
...
func Test_CheckDevicesAgainstCriteria(t *testing.T) {
	...
	devicesInfoSlice := []SupDevice{
		{"eth0", "", "1593", "", 0, 64, LINK_STATE_INVALID_VALUE, INVALID_VALUE_FOR_NUMA_NODE, "", false,
			false, false, INVALID_VALUE_FOR_SPECIFIC_PORT, "", false, false, false},
		{"eth1", "", "eyal", "driver2", 0, 64, LINK_STATE_INVALID_VALUE, INVALID_VALUE_FOR_NUMA_NODE,
			"", false, false, false, INVALID_VALUE_FOR_SPECIFIC_PORT, "", false, false, false},
		...
		{"eth7", "", "0d58", "driver2", 10000, 64, 1, 7, "", false, false, false,
			INVALID_VALUE_FOR_SPECIFIC_PORT, "", false, false, false},
		...
		{"eth13", "", "0d58", "driver2", 40000, 64, 1, 0, "SATA", true, false, false,
			3, "0000:cc:00.x", false, false, false},
		{"eth14", "", "0d58", "driver2", 40000, 64, 1, 0, "SATA", true, false, false,
			3, "0000:cc:00.x", true, false, false},
	}
	...
	pf5 := CriteriaList{"FH", []string{"158a", "0d58", "1593", "159b", "1592", "188a"}, []string{"driver2"},
		40000, 64, 1, 0, []string{"SATA"}, true, false, false, 3, "pf6", true, "0000:cc:00.x", ""}
	...
	pf6 := CriteriaList{"FH", []string{"158a", "0d58", "1593", "159b", "1592", "188a"}, []string{"driver2"},
		40000, 64, 1, 0, []string{"SATA"}, true, false, false, 3, "pf5", false, "0000:cc:00.x", ""}
...
func Test_YamlFileValidation(t *testing.T) {
	...
	firstCriteriaList := CriteriaList{"APP", nil, nil, 0, 100, 2, -1, nil, false, false, false, -1, "pf1", false, "", ""}
	CRITERIA_LISTS_MAP_WITH_CARD_AFFINITY["pf1"] = &firstCriteriaList
	err = YamlFileValidation(CRITERIA_LISTS_MAP_WITH_CARD_AFFINITY)
	if err == nil {
	...
	secondCriteriaList := CriteriaList{"APP", nil, nil, 0, 100, 2, -1, nil, false, false, true, -1, "pf3", false, "", ""}
...
func Test_CheckVendorNameAndProductId(t *testing.T) {
	...
	result, deviceId := CheckVendorNameAndProductId(ptrPci, NIC_BUS_INFO, "eth0")
	...
	result, _ = CheckVendorNameAndProductId(ptrPci, "invalid_Bus_Info", "eth0")
	if result == true {
	...
	result, _ = CheckVendorNameAndProductId(ptrPci, NETWORK_BUS_INFO_OF_NON_INTEL_NIC, "eno8303")
	if result == true {
