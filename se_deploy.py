...
"""
Deployment-only control script wrapper adjusting it to a specific experience kit
"""
...
if __name__ == "__main__":
    ...
    import se_deploy_cli # pylint: disable=import-error
    se_deploy_cli.run_main(CFG)
