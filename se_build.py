...
"""
Offline installation package build script wrapper adjusting it to a specific experience kit
"""
...
if __name__ == "__main__":
    ...
    import se_build_cli # pylint: disable=import-error
    se_build_cli.run_main(CFG)
